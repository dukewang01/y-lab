...
ORDER_FILE = r'C:\Users\Duke Wang\.openclaw\workspace\media\incoming\商城订单2026-05-04_2023H1.txt'
...
print('历史订单(2023H1): ' + str(len(rows)) + '条')
...
for r in rows:
    ...
    if not guest:
        ...
        guest = {
            'id': member_id or 'SHOP_2023H1_' + phone,
            'name': name_clean or '微信用户',
            'phone': phone,
            'source': '小程序商城订单(2023H1)',
            'notes': '商城客户(2023H1)',
        }
        guests.append(guest)
        new_guests += 1
