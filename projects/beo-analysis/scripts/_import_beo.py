...
FB_GRAPH = Path(r"C:\Users\Y\.openclaw\workspace\knowledge_center\fb_graph.json")
BEO_DATA = Path(r"C:\Users\Y\.openclaw\workspace\knowledge_center\_raw_beo.txt")

# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•?# Step 1: Parse the BEO text
...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•?# Step 2: Import into FIN + FB graphs
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•?
# First backup
import shutil
...
# â”€â”€ FIN graph: BEO report entity â”€â”€
...
if not exists_in(fin['entities'], REPORT_ID):
    ...
    print("âœ?Created BEO report entity")
...
print(f"  Date range: {event_blocks[0][0]} â†?{event_blocks[-1][0]}")

# â”€â”€ Save both graphs â”€â”€
with open(FIN_GRAPH, "w", encoding="utf-8") as f:
    json.dump(fin, f, ensure_ascii=False, indent=2)

print(f"\nâœ?FIN graph saved ({len(fin['entities'])} entities, {len(fin['relationships'])} relationships)")
